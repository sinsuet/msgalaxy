...
def main():
    ...
    print("=" * 80)
    print("🚀 MsGalaxy L2 进阶级测试 (Intermediate)")
    print("=" * 80)
    print("📦 组件数量: 3个")
    print("🎯 测试目标: 质心偏置+高热源，触发散热器、涂层、支架算子")
    print("⏱️  预期时间: 15-25分钟")
    print("🔄 最大迭代: 10次")
    print("=" * 80)
    print()
    ...
    try:
        # L2配置：强制覆盖
        orchestrator.config['optimization']['max_iterations'] = 10

        final_state = orchestrator.run_optimization(
            bom_file=str(project_root / "config" / "bom_L2_intermediate.json"),
            max_iterations=10
        )
